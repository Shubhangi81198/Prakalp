...
if(empty($username_err) && empty($password_err) && empty($confirm_password_err)&& empty($fullname_err))
{
    ...
    if ($stmt)
    {
        mysqli_stmt_bind_param($stmt, "sss", $param_username, $param_password, $fullname);
...
<form action="" method="post">
  ...
  <button type="submit" class="btn btn-primary">Sign in </button>  &nbsp; &nbsp;
    <li><span>Already have an account ?</span><a  href="login.php"> Login Here</a></li>
</div>
